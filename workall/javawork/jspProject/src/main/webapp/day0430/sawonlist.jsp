...
<div style="margin: 20px 50px">
    ...
    <button type="button" class="btn btn-success"
            style="width: 170px"
            onclick="location.href='sawonbuseoanalysis.jsp'">우리회사부서분석표</button>
</div>
<%
    for (SawonDto dto : list) {%>
<div class="list">
  <img src='<%=dto.getPhoto().equals("no")?"../image/noimage/no1.png":dto.getPhoto()%>'>
    <br><%=dto.getName()%>사원
    <br>
    <button type="button" class="btn btn-sm btn-outline-danger"
            onclick="location.href='sawondetail.jsp?num=<%=dto.getNum()%>'">상세보기
    </button>
</div>
<%
    }
