    ...
    <table>
        ...
        <tr>
            <td width="250">
                <img style="width: 230px;"
                     src='<%=dto.getPhoto().equals("no")?"../image/noimage/no1.png":dto.getPhoto()%>'>
            </td>
            <td>
        ...
        <tr height="60">
            <td colspan="2" align="center">
                ...
                <button type="button" class="btn btn-sm btn-warning" id="Changing"
                        style="width: 80px;"
...
<script type="text/javascript">
    ...
    $("#delsawon").click(function () {
        ...
        let a=confirm(`\<%=dto.getName()%> 사원정보를 삭제할까요?`)
        if (a) {
